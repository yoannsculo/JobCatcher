...
configs = {
    ...
    'RegionJob': {
        'feeds': [
            'http://www.pacajob.com/fr/rss/flux.aspx?ville=9',
        ]
    },
    'Eures': {
        'feeds': [
...
configstest = {
    ...
    'RegionJob': {
        'feeds': [
            'http://www.centrejob.com/fr/rss/flux.aspx?&fonction=10',
            'http://www.nordjob.com/fr/rss/flux.aspx?&fonction=10',
            'http://www.pacajob.com/fr/rss/flux.aspx?&fonction=10',
            'http://www.rhonealpesjobs.com/fr/rss/flux.aspx?&fonction=10',
            'http://www.estjob.com/fr/rss/flux.aspx?&fonction=10',
            'http://www.ouestjob.com/fr/rss/flux.aspx?&fonction=10',
            'http://www.sudouestjob.com/fr/rss/flux.aspx?&fonction=10',
            'http://www.parisjob.com/fr/rss/flux.aspx?&fonction=10',
        ]
    },
    'Eures': {
        'feeds': [
