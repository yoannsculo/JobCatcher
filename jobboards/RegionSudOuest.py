...
class RegionSudOuest(Jobboard):

    def __init__(self):
        self.name = "SUDOUESTJOB"
        self.url = "http://www.sudouestjob.com"
        self.lastFetch = ""
        self.processingDir = self.dlDir + "/sudouestjob"
...
#            print "link " + link
    ...
    def fetch(self):
        ...
        feed_list = ['http://www.sudouestjob.com/fr/rss/flux.aspx?&fonction=22&qualification=2'] # devel hardware
...
class SudOuestOffer(Offer):
	...
	self.salary = u'NA'
        ...
        self.url = "http://www.sudouestjob.com/clients/offres_chartees/" + os.path.basename(filename).split( '&' )[0]
